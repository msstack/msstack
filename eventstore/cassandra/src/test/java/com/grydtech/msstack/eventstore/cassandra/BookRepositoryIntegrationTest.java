...
public class BookRepositoryIntegrationTest {
    ...
    public void whenCreatingATable_thenCreatedCorrectly() {
        ...
        List<String> columnNames = result.getColumnDefinitions().asList().stream().map(cl -> cl.getDatabaseName()).collect(Collectors.toList());
    ...
    public void whenAlteringTable_thenAddedColumnExists() {
        ...
        boolean columnExists = result.getColumnDefinitions().asList().stream().anyMatch(cl -> cl.getDatabaseName().equals("publisher"));
